-- Row Level Security Policies for DM Tables
...
-- Policy for dm_participants: Users can view participants in their conversations
CREATE POLICY "Users can view participants in their conversations" ON dm_participants
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM dm_participants p2
      WHERE p2.conversation_id = dm_participants.conversation_id 
