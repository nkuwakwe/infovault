-- Migration: Add guild_id column to guilds table
-- This will be used to uniquely identify guilds by their Discord ID
-- Created: 2025-02-06

-- Add guild_id column to store Discord guild IDs as text
ALTER TABLE guilds ADD COLUMN IF NOT EXISTS guild_id TEXT;
...
ALTER TABLE guilds ADD CONSTRAINT unique_guild_id UNIQUE (guild_id);

-- RLS policy for guild_id
